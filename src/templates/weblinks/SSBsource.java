...
public class SSBsource {
    ...
    /**
     * Returns the source for the population/area statistics for the tettsteder of 2019.
     *
     * @return the source
     */
    ...
    /**
     * Returns the source for the population/area statistics for the tettsteder.
     *
     * @return the source
     */
    ...
    /**
     * Returns the source for the 1999 SSB report about the changes in municipalities and provinces.
     *
     * @return the source
     */
    ...
    /**
     * Returns the source for the commuters.
     *
     * @return the source
     */
    ...
    /**
     * Returns the source for the areal types.
